...
Повторяю примеры приведенные в лабораторной работе.

![Повторение примеров](image/1.png){#fig:001 width=70%}

##

Работаю с командами mv и cp.

![Команды mv и cp](image/2.png){#fig:002 width=70%}

##

Меняю права доступов для файлов и каталогов.

![Изменение прав доступа](image/3.png){#fig:003 width=70%}

##

Проверка измененных прав доступа.
...
![Документация по командам](image/5.png){#fig:005 width=70%}
