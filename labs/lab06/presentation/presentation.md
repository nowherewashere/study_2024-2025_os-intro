...
С разными флагами использую команду ls.

![Использование команды ls](image/2.png){#fig:002 width=70%}

##

Проверяю, есть ли подкаталог cron в /var/spool.
...
Смотрю историю команд и изменяю некоторые.

![Изменение команд через hisory](image/6.png){#fig:006 width=70%}
