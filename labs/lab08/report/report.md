...
Вывожу все файлы, начинающиеся на с. (рис. -@fig:003)

![Фильтрация поиска](image/3.png){#fig:003 width=70%}

Вывожу все файлы, начинаеющиеся на h. (рис. -@fig:005)

![Фильтрация поиска](image/5.png){#fig:005 width=70%}

Записываю все логи в файл. (рис. -@fig:006)

![Запись местоположений лог файлов](image/6.png){#fig:006 width=70%}

Открываю в фоне процесс и завершаю его. (рис. -@fig:007)

![Завершение процессов через терминал](image/7.png){#fig:007 width=70%}

Вывожу все директории домашнего каталога. (рис. -@fig:008)

![Вывод всех директорий](image/8.png){#fig:008 width=70%}
